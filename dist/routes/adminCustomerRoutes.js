...
exports.adminCustomerRoutes = adminCustomerRoutes;
const ctrl = __importStar(require("../controllers/adminCustomerController"));
async function adminCustomerRoutes(fastify) {
