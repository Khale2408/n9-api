...
exports.adminProductRoutes = adminProductRoutes;
const ctrl = __importStar(require("../controllers/adminProductController"));
async function adminProductRoutes(fastify) {
